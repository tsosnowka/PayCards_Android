...
public final class InitLibraryFragment extends BaseScanCardFragment {
    ...
    public static DeployCoreTask mDeployCoreTask;
    ...
    private void subscribeToInitCore() {
        if (!RecognitionCoreUtils.isRecognitionCoreDeployRequired(getContext())) {
            return;
        }
        showProgress();
        ...
        mDeployCoreTask = new DeployCoreTask(context.getApplicationContext(), deployCoreTaskCallback);
